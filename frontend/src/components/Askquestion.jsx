...
const Askquestion = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response && response[0] && response[0][0] && response[0][0].label === "LABEL_0") {
  ...
  return (
    <div className="h-full md:w-[50%]">
      ...
      gap-4 mb-12 border p-4 pb-6 rounded-2xl bg-red-300 
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="form w-full">
          <div className="title">
            <label className="text-gray-800 text-start dark:text-white font-bold text-black">
              Post Title
            </label>
            <input
              name="title"
              className="mt-2 w-full h-10 px-3 rounded outline-none border-none shadow-sm text-black"
              type="text"
            />
          </div>
          <div className="desc mt-3">
            ...
            <textarea
              name="description"
              className="mt-2 w-full h-24 px-3 py-2 rounded outline-none border-none shadow-sm text-black"
              type="text"
            />
          </div>
